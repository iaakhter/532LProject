...
class Spatial_CNN():
    ...
    def build_model(self):
        ...
        self.model = resnet18(channel=2, num_classes=arg.num_classes).cuda()
    ...
    def run(self):
        ...
        for self.epoch in range(self.start_epoch, self.nb_epochs):
            ...
            },is_best,'checkpoints_twochannels/checkpoint.pth.tar','checkpoints_twochannels/model_best.pth.tar')
    ...
    def train_1epoch(self):
        ...
        for i, (data,label) in enumerate(progress):
            ...
            # compute output
            #output = Variable(torch.zeros(1,arg.num_classes).float()).cuda()
            ...
            prec1, prec5 = accuracy(output.data, label, topk=(1, 2))
        ...
        record_info(info, 'checkpoints_twochannels/rgb_train.csv','train')
    ...
    def validate_1epoch(self):
        ...
        record_info(info, 'checkpoints_twochannels/rgb_test.csv','test')
